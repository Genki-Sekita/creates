...
public class MyOval extends MyDrawing{
	...
	public MyOval(int xpt, int ypt, int wide, int hight, Color lineColor, Color fillColor, int lineWidth){
		super(wide, hight, lineColor, fillColor, lineWidth);
		setLocation(xpt, ypt);
	}
	
	public MyOval(int xpt, int ypt, int wide, int hight){
		super(wide, hight);
		setLocation(xpt, ypt);
	}
	
	public MyOval(int xpt, int ypt, Color lineColor, Color fillColor, int lineWidth){
	...
	public void draw(Graphics g){
		...
		if(getKage()){
			...
			g2.fillOval(x+7, y+7, w, h);
			g2.setColor(Color.black);
			g2.drawOval(x+7, y+7, w, h);
		}
